...
class SmurfCommandMixin(SmurfBase):
    ...
    # Standard PFB subband-center frequency offsets (MHz). These values are
    # identical for every 500 MHz band in all existing SMuRF firmware builds
    # (the per-band parameterization in firmware is reserved for hypothetical
    # future use). Used as offline-mode fallback so that old tracking_setup
    # debug .dat files can be decoded with correct channel ordering. See
    # issue #674.
    _default_tone_frequency_offset_mhz = np.array([
        0.0, 307.2, 153.6, -153.6, 76.8, -230.4, 230.4, -76.8,
        38.4, -268.8, 192.0, -115.2, 115.2, -192.0, 268.8, -38.4,
        19.2, -288.0, 172.8, -134.4, 96.0, -211.2, 249.6, -57.6,
        57.6, -249.6, 211.2, -96.0, 134.4, -172.8, 288.0, -19.2,
        9.6, -297.6, 163.2, -144.0, 86.4, -220.8, 240.0, -67.2,
        48.0, -259.2, 201.6, -105.6, 124.8, -182.4, 278.4, -28.8,
        28.8, -278.4, 182.4, -124.8, 105.6, -201.6, 259.2, -48.0,
        67.2, -240.0, 220.8, -86.4, 144.0, -163.2, 297.6, -9.6,
        4.8, -302.4, 158.4, -148.8, 81.6, -225.6, 235.2, -72.0,
        43.2, -264.0, 196.8, -110.4, 120.0, -187.2, 273.6, -33.6,
        24.0, -283.2, 177.6, -129.6, 100.8, -206.4, 254.4, -52.8,
        62.4, -244.8, 216.0, -91.2, 139.2, -168.0, 292.8, -14.4,
        14.4, -292.8, 168.0, -139.2, 91.2, -216.0, 244.8, -62.4,
        52.8, -254.4, 206.4, -100.8, 129.6, -177.6, 283.2, -24.0,
        33.6, -273.6, 187.2, -120.0, 110.4, -196.8, 264.0, -43.2,
        72.0, -235.2, 225.6, -81.6, 148.8, -158.4, 302.4, -4.8,
        2.4, -304.8, 156.0, -151.2, 79.2, -228.0, 232.8, -74.4,
        40.8, -266.4, 194.4, -112.8, 117.6, -189.6, 271.2, -36.0,
        21.6, -285.6, 175.2, -132.0, 98.4, -208.8, 252.0, -55.2,
        60.0, -247.2, 213.6, -93.6, 136.8, -170.4, 290.4, -16.8,
        12.0, -295.2, 165.6, -141.6, 88.8, -218.4, 242.4, -64.8,
        50.4, -256.8, 204.0, -103.2, 127.2, -180.0, 280.8, -26.4,
        31.2, -276.0, 184.8, -122.4, 108.0, -199.2, 261.6, -45.6,
        69.6, -237.6, 223.2, -84.0, 146.4, -160.8, 300.0, -7.2,
        7.2, -300.0, 160.8, -146.4, 84.0, -223.2, 237.6, -69.6,
        45.6, -261.6, 199.2, -108.0, 122.4, -184.8, 276.0, -31.2,
        26.4, -280.8, 180.0, -127.2, 103.2, -204.0, 256.8, -50.4,
        64.8, -242.4, 218.4, -88.8, 141.6, -165.6, 295.2, -12.0,
        16.8, -290.4, 170.4, -136.8, 93.6, -213.6, 247.2, -60.0,
        55.2, -252.0, 208.8, -98.4, 132.0, -175.2, 285.6, -21.6,
        36.0, -271.2, 189.6, -117.6, 112.8, -194.4, 266.4, -40.8,
        74.4, -232.8, 228.0, -79.2, 151.2, -156.0, 304.8, -2.4,
        1.2, -306.0, 154.8, -152.4, 78.0, -229.2, 231.6, -75.6,
        39.6, -267.6, 193.2, -114.0, 116.4, -190.8, 270.0, -37.2,
        20.4, -286.8, 174.0, -133.2, 97.2, -210.0, 250.8, -56.4,
        58.8, -248.4, 212.4, -94.8, 135.6, -171.6, 289.2, -18.0,
        10.8, -296.4, 164.4, -142.8, 87.6, -219.6, 241.2, -66.0,
        49.2, -258.0, 202.8, -104.4, 126.0, -181.2, 279.6, -27.6,
        30.0, -277.2, 183.6, -123.6, 106.8, -200.4, 260.4, -46.8,
        68.4, -238.8, 222.0, -85.2, 145.2, -162.0, 298.8, -8.4,
        6.0, -301.2, 159.6, -147.6, 82.8, -224.4, 236.4, -70.8,
        44.4, -262.8, 198.0, -109.2, 121.2, -186.0, 274.8, -32.4,
        25.2, -282.0, 178.8, -128.4, 102.0, -205.2, 255.6, -51.6,
        63.6, -243.6, 217.2, -90.0, 140.4, -166.8, 294.0, -13.2,
        15.6, -291.6, 169.2, -138.0, 92.4, -214.8, 246.0, -61.2,
        54.0, -253.2, 207.6, -99.6, 130.8, -176.4, 284.4, -22.8,
        34.8, -272.4, 188.4, -118.8, 111.6, -195.6, 265.2, -42.0,
        73.2, -234.0, 226.8, -80.4, 150.0, -157.2, 303.6, -3.6,
        3.6, -303.6, 157.2, -150.0, 80.4, -226.8, 234.0, -73.2,
        42.0, -265.2, 195.6, -111.6, 118.8, -188.4, 272.4, -34.8,
        22.8, -284.4, 176.4, -130.8, 99.6, -207.6, 253.2, -54.0,
        61.2, -246.0, 214.8, -92.4, 138.0, -169.2, 291.6, -15.6,
        13.2, -294.0, 166.8, -140.4, 90.0, -217.2, 243.6, -63.6,
        51.6, -255.6, 205.2, -102.0, 128.4, -178.8, 282.0, -25.2,
        32.4, -274.8, 186.0, -121.2, 109.2, -198.0, 262.8, -44.4,
        70.8, -236.4, 224.4, -82.8, 147.6, -159.6, 301.2, -6.0,
        8.4, -298.8, 162.0, -145.2, 85.2, -222.0, 238.8, -68.4,
        46.8, -260.4, 200.4, -106.8, 123.6, -183.6, 277.2, -30.0,
        27.6, -279.6, 181.2, -126.0, 104.4, -202.8, 258.0, -49.2,
        66.0, -241.2, 219.6, -87.6, 142.8, -164.4, 296.4, -10.8,
        18.0, -289.2, 171.6, -135.6, 94.8, -212.4, 248.4, -58.8,
        56.4, -250.8, 210.0, -97.2, 133.2, -174.0, 286.8, -20.4,
        37.2, -270.0, 190.8, -116.4, 114.0, -193.2, 267.6, -39.6,
        75.6, -231.6, 229.2, -78.0, 152.4, -154.8, 306.0, -1.2,
    ])
    ...
    def get_tone_frequency_offset_mhz(self, band, **kwargs):
        ...
        """
        if self.offline:
            return self._default_tone_frequency_offset_mhz.copy()
        return self._caget(
            self._band_root(band) +
            self._tone_frequency_offset_mhz_reg,
            **kwargs)
