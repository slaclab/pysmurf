...
pysmurf_init() {
	...
	# for pip installs, prevent python from trying to load pysmurf if in repo in docker
	...
	# define some local variables that some smurf_startup functions will use later
