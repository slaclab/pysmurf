...
"""
def fit_data(tune_file, band, db_offset=1, plot=False):
...
def logDebugData(S, band, reschannel, nsamp, sync, filename, tunefile, cooldown_str, char_avgs={}, awg_settings={}, led_settings={}, MEMS_settings={}):
