########
# From Tristan PM, April 2026. Supposedly written partially by Claude Code. read_next_frame() appears to be broken
########

# uncomment this line if you want to run cython in a Jupyter notebook
# %%cython

import numpy as np
cimport numpy as np
from libc.stdint cimport uint8_t, uint16_t, uint32_t, int32_t
from libc.stdio cimport FILE, fopen, fread, fclose, feof, SEEK_SET, SEEK_END, fseek, ftell, rewind
...
cdef class SmurfFileReader:
    ...
    def py_read_smurf_header(self, header_buffer):
        return self.read_smurf_header(header_buffer)
    ...
    cdef FileStats count_frames(self) except *:
        ...
        while True:
            ...
            if dw_header.channel_id == 0:
                ...
                fseek(self.fp, payload_size_bytes - SMURF_HEADER_SIZE, 1)  # SEEK_CUR = 1
            elif dw_header.channel_id == 1:
                # Metadata frame
