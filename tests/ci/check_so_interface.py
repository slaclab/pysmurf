...
def compare_args(node, intdict, classname, funcname):
    if isinstance(node, ast.FunctionDef):
        ...
        if has_varargs == True:
            raise NotImplementedError("This code doesn't currently have the functionality to support varargs, " + funcname + " has vararg")
        if has_kwargs == True:
            raise NotImplementedError("This code doesn't currently have the functionality to support kwargs, " + funcname + " has kwarg")
